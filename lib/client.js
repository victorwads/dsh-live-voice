  ...
  function MicrophoneButtons({ controller }) {
    ...
    return h(
      ...
      h(Button, {
        className: "dlv-mic",
        icon: "mic",
        label: pending ? "Checking microphone availability" : unavailable ? reason || "Speech recognition unavailable" : "Voice typing",
        disabled: pending,
    ...
    return h(
      ...
      h(
        ...
        h(
          ...
          settings.engine === "qwen-http" ? subcard("Qwen server connection", [
