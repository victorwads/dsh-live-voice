...
// src/client/whisper-settings.tsx
var import_react3 = __toESM(require("react"), 1);

// src/client/i18n-react.tsx
...
function toLanguage(dictionary) {
  ...
  for (const [identifier, template] of Object.entries(dictionary)) {
    ...
    parent[path.at(-1)] = ((params) => interpolate(template, params));
  }
  return root;
}
var languageLabels = new Map(LIVE_VOICE_LANGUAGES.map(({ id: id2, label }) => [id2, label]));
var availableLangs = Object.fromEntries(
  Object.entries(liveVoiceDictionaries).map(([id2, dictionary]) => [
    id2,
    {
      name: languageLabels.get(id2) ?? id2,
      short: id2,
      locale: id2,
...
function DshLanguageBoundary({ locale, children }) {
...
function withLiveVoiceLanguage(Component, locale) {
  function LocalizedSlot(props) {
...
function WhisperSettings({ controller }) {
  ...
  const [busy, setBusy] = import_react3.default.useState(true);
  const [loaded, setLoaded] = import_react3.default.useState(false);
  const [error, setError] = import_react3.default.useState("");
  const [message2, setMessage] = import_react3.default.useState("");
  const active = import_react3.default.useRef(null);
  ...
  function field(label, key, type = "text") {
    return /* @__PURE__ */ import_react3.default.createElement("label", null, label, /* @__PURE__ */ import_react3.default.createElement(
      "input",
      {
        type,
        value: draft[key],
  ...
  return /* @__PURE__ */ import_react3.default.createElement(import_react3.default.Fragment, null, /* @__PURE__ */ import_react3.default.createElement("p", null, settings.whisper.hostHelp()), field(commons.connection.endpoint(), "url"), field(commons.connection.healthEndpoint(), "healthUrl"), field(commons.connection.timeout(), "timeoutMs", "number"), /* @__PURE__ */ import_react3.default.createElement("div", { className: "dlv-settings-actions" }, /* @__PURE__ */ import_react3.default.createElement("button", { type: "button", disabled: busy || !loaded, onClick: () => run("save") }, recognition.whisper.save()), /* @__PURE__ */ import_react3.default.createElement("button", { type: "button", disabled: busy || !loaded, onClick: () => run("test") }, commons.connection.test()), /* @__PURE__ */ import_react3.default.createElement("button", { type: "button", disabled: busy, onClick: () => run("load") }, commons.connection.reload())), busy && /* @__PURE__ */ import_react3.default.createElement("p", { role: "status" }, commons.connection.contactingHost()), message2 && /* @__PURE__ */ import_react3.default.createElement("p", { role: "status" }, translateStatus(message2)), error && /* @__PURE__ */ import_react3.default.createElement("p", { role: "alert" }, translateStatus(error)));
}
function createWhisperSettings() {
  return WhisperSettings;
}

// src/client/qwen-settings.tsx
...
function QwenSettings({ controller }) {
  ...
  const [draft, setDraft] = import_react4.default.useState({
    baseUrl: "http://127.0.0.1:8080/",
    timeoutMs: 3e5
  });
  const [busy, setBusy] = import_react4.default.useState(true);
  const [loaded, setLoaded] = import_react4.default.useState(false);
  const [error, setError] = import_react4.default.useState("");
  const [message2, setMessage] = import_react4.default.useState("");
  const active = import_react4.default.useRef(null);
  const translateStatus = (value) => ({
    "dsh-live-voice.commons.connection.unsaved": commons.connection.unsaved(),
  ...
  const field = (label, key, type = "text") => /* @__PURE__ */ import_react4.default.createElement("label", null, label, /* @__PURE__ */ import_react4.default.createElement(
    "input",
    {
      type,
      value: draft[key],
  ...
  return /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, /* @__PURE__ */ import_react4.default.createElement("p", null, recognition.qwen.hostHelp()), field(speak.qwen.endpoint(), "baseUrl"), field(commons.connection.timeout(), "timeoutMs", "number"), /* @__PURE__ */ import_react4.default.createElement("div", { className: "dlv-settings-actions" }, /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", disabled: busy || !loaded, onClick: () => run("save") }, speak.qwen.save()), /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", disabled: busy || !loaded, onClick: () => run("test") }, speak.qwen.test()), /* @__PURE__ */ import_react4.default.createElement("button", { type: "button", disabled: busy, onClick: () => run("load") }, commons.connection.reload())), busy && /* @__PURE__ */ import_react4.default.createElement("p", { role: "status" }, commons.connection.contactingHost()), message2 && /* @__PURE__ */ import_react4.default.createElement("p", { role: "status" }, translateStatus(message2)), error && /* @__PURE__ */ import_react4.default.createElement("p", { role: "alert" }, translateStatus(error)));
}
function createQwenSettings() {
  return QwenSettings;
}
...
function createComponents(React5, translate = createFallbackTranslator(), locale) {
  ...
  const WhisperSettings2 = createWhisperSettings(React5, t);
  const QwenSettings2 = createQwenSettings(React5, t);
  function useController(controller) {
    const subscribe = React5.useCallback((listener) => controller.subscribe(listener), [controller]);
    const read = React5.useCallback(() => controller.getSnapshot(), [controller]);
    return React5.useSyncExternalStore(subscribe, read, read);
  }
  function Icon({ name }) {
    const common = {
      viewBox: "0 0 24 24",
    ...
    return /* @__PURE__ */ React5.createElement("svg", { ...common }, /* @__PURE__ */ React5.createElement("path", { d: paths[name] || paths.mic }));
  }
  function Button({
    label,
    icon,
    ...
    return /* @__PURE__ */ React5.createElement(
      ...
      /* @__PURE__ */ React5.createElement(Icon, { name: icon }),
      visibleLabel ? /* @__PURE__ */ React5.createElement("span", { className: "dlv-toggle-state", "aria-hidden": true }, visibleLabel) : null
    );
  }
  ...
  function ErrorText({ error, onDismiss }) {
    ...
    return error ? /* @__PURE__ */ React5.createElement("div", { className: "dlv-error", role: "alert" }, String(error), onDismiss ? /* @__PURE__ */ React5.createElement(
      "button",
      {
        type: "button",
  ...
  function MicrophoneButtons({ controller }) {
    ...
    ), /* @__PURE__ */ React5.createElement(ErrorText, { error, onDismiss: clearError }));
  }
  function Waveform({ controller, enabled }) {
    ...
    return /* @__PURE__ */ React5.createElement("canvas", { ref, className: "dlv-wave", "aria-hidden": true });
  }
  function RecordingBar({ controller, questionOnly = false, overlay = false, overlayStyle }) {
    ...
    return /* @__PURE__ */ React5.createElement(
      ...
      /* @__PURE__ */ React5.createElement(
        ...
        capture && !state.conversation ? /* @__PURE__ */ React5.createElement(
          Button,
          {
        ...
        state.conversation ? /* @__PURE__ */ React5.createElement(
          Button,
          {
        ...
        /* @__PURE__ */ React5.createElement(Waveform, { controller, enabled: Boolean(state.listening) }),
        /* @__PURE__ */ React5.createElement("span", { className: "dlv-status", role: "status", "aria-live": "polite" }, localizedStatus),
        /* @__PURE__ */ React5.createElement(
          Button,
          {
        ...
        remaining ? /* @__PURE__ */ React5.createElement(
          Button,
          {
        ...
        state.conversation && !capture ? /* @__PURE__ */ React5.createElement(
          Button,
          {
        ...
        capture ? /* @__PURE__ */ React5.createElement(
          Button,
          {
        ...
        state.speechSegmentsRemaining > 1 ? /* @__PURE__ */ React5.createElement(
          Button,
          {
        ...
        state.speechSegmentsRemaining > 0 && state.capabilities[state.settings.engine]?.pause ? /* @__PURE__ */ React5.createElement(
          Button,
          {
        ...
        state.paused && state.capabilities[state.settings.engine]?.resume ? /* @__PURE__ */ React5.createElement(
          Button,
          {
        ...
        state.speechSegmentsRemaining > 0 ? /* @__PURE__ */ React5.createElement(
          Button,
          {
  ...
  function SettingsPanel({ controller, onClose }) {
    ...
    const tabsId = React5.useId();
    const [latestRelease, setLatestRelease] = React5.useState(null);
    React5.useEffect(() => {
      let active = true;
    ...
    const [activeTab, setActiveTab] = React5.useState("conversation");
    ...
    const [audioDevices, setAudioDevices] = React5.useState([]);
    React5.useEffect(() => {
      let active = true;
      const refresh = async () => {
        try {
    ...
    const field = (label, key, options) => /* @__PURE__ */ React5.createElement("label", { key }, localize(label), /* @__PURE__ */ React5.createElement(
      "select",
      {
      ...
      options.map((option) => /* @__PURE__ */ React5.createElement("option", { key: option.value, value: option.value, disabled: option.disabled }, localize(option.label)))
    ));
    const panel = (id2, children) => /* @__PURE__ */ React5.createElement(
      "div",
      {
        id: `${tabsId}-panel-${id2}`,
    ...
    const subcard = (title, children, open = false) => /* @__PURE__ */ React5.createElement("details", { className: "dlv-settings-subcard", open }, /* @__PURE__ */ React5.createElement("summary", null, localize(title)), /* @__PURE__ */ React5.createElement("div", { className: "dlv-settings-subcard-body" }, children));
    return /* @__PURE__ */ React5.createElement("section", { className: "dlv-settings", "aria-label": t("dsh-live-voice.settings.title") }, /* @__PURE__ */ React5.createElement("div", { className: "dlv-settings-heading" }, /* @__PURE__ */ React5.createElement("h3", null, t("dsh-live-voice.commons.pluginName")), /* @__PURE__ */ React5.createElement(
      "div",
      {
      ...
      /* @__PURE__ */ React5.createElement(
        ...
        /* @__PURE__ */ React5.createElement("img", { src: LIVE_VOICE_BADGE_URL, alt: "" }),
        /* @__PURE__ */ React5.createElement("span", null, `v${CURRENT_VERSION}`)
      ),
      /* @__PURE__ */ React5.createElement(
        "a",
        {
        ...
        /* @__PURE__ */ React5.createElement("img", { src: DSH_BADGE_URL, alt: "" }),
        /* @__PURE__ */ React5.createElement("span", null, `v${TESTED_DSH_VERSION}`)
      )
    ), /* @__PURE__ */ React5.createElement("span", { className: "dlv-heading-divider", "aria-hidden": true }), updateAvailable ? /* @__PURE__ */ React5.createElement(
      "a",
      {
      ...
      /* @__PURE__ */ React5.createElement("span", { className: "dlv-update-icon", "aria-hidden": true }, "\u2191"),
      t("dsh-live-voice.commons.update.label")
    ) : null, updateAvailable ? /* @__PURE__ */ React5.createElement("span", { className: "dlv-heading-divider", "aria-hidden": true }) : null, /* @__PURE__ */ React5.createElement(
      "a",
      {
      ...
      /* @__PURE__ */ React5.createElement("span", { className: "dlv-star-icon", "aria-hidden": true }, "\u2605"),
      t("dsh-live-voice.commons.repository.starLabel")
    )), onClose ? /* @__PURE__ */ React5.createElement(Button, { label: t("dsh-live-voice.settings.close"), icon: "close", onClick: onClose }) : null, /* @__PURE__ */ React5.createElement(
      "div",
      {
      ...
      /* @__PURE__ */ React5.createElement("div", { className: "dlv-settings-card-body" }, field("dsh-live-voice.speak.engine.label", "engine", [
        {
          value: "qwen-http",
      ...
      ) : /* @__PURE__ */ React5.createElement("small", null, t("dsh-live-voice.speak.macos.outputHelp")), settings.engine === "browser" ? /* @__PURE__ */ React5.createElement(React5.Fragment, null, /* @__PURE__ */ React5.createElement("small", null, t("dsh-live-voice.speak.browser.outputHelp")), field("dsh-live-voice.speak.browser.voice", "voice", [
        {
          value: "",
      ...
      ])) : null, settings.engine === "qwen-http" ? /* @__PURE__ */ React5.createElement(React5.Fragment, null, field(
      ...
      ), /* @__PURE__ */ React5.createElement("small", null, t("dsh-live-voice.speak.qwen.voiceHelp")), subcard("dsh-live-voice.speak.qwen.connection", [
        /* @__PURE__ */ React5.createElement(QwenSettings2, { key: "qwen-output-settings", controller })
      ])) : null, subcard("dsh-live-voice.settings.filters.title", [
        /* @__PURE__ */ React5.createElement("label", { key: "output-code-filter", className: "dlv-check" }, /* @__PURE__ */ React5.createElement(
          "input",
          {
            type: "checkbox",
        ...
        /* @__PURE__ */ React5.createElement("label", { key: "output-code-lines" }, t("dsh-live-voice.speak.filters.code.maxLines"), /* @__PURE__ */ React5.createElement(
          "input",
          {
            type: "number",
            min: 0,
        ...
        /* @__PURE__ */ React5.createElement("label", { key: "output-code-notice" }, t("dsh-live-voice.speak.filters.code.replacement"), /* @__PURE__ */ React5.createElement(
          "input",
          {
            type: "text",
            maxLength: 300,
            ...
            disabled: settings.outputCodeFilterEnabled === false,
            onBlur: (event) => invoke("updateSettings", {
              outputCodeNotice: event.target.value
            })
          }
        ))
      ]), /* @__PURE__ */ React5.createElement("div", { className: "dlv-settings-subcard" }, /* @__PURE__ */ React5.createElement("label", null, /* @__PURE__ */ React5.createElement(
        "input",
        {
          type: "checkbox",
      ...
      ), t("dsh-live-voice.speak.agentContext.enabled")), /* @__PURE__ */ React5.createElement("small", null, t("dsh-live-voice.speak.agentContext.enabledHelp")), /* @__PURE__ */ React5.createElement("label", null, t("dsh-live-voice.speak.agentContext.label")), /* @__PURE__ */ React5.createElement("small", null, t("dsh-live-voice.speak.agentContext.help")), /* @__PURE__ */ React5.createElement(
        "textarea",
        {
      ...
      )), /* @__PURE__ */ React5.createElement("label", null, t("dsh-live-voice.speak.rate.label"), /* @__PURE__ */ React5.createElement(
        "input",
        {
          type: "number",
          min: 0.1,
      ...
      ), /* @__PURE__ */ React5.createElement("small", null, t("dsh-live-voice.speak.rate.help"))), /* @__PURE__ */ React5.createElement("label", null, t("dsh-live-voice.speak.segmentGap.label"), /* @__PURE__ */ React5.createElement(
        "input",
        {
          type: "number",
          min: 0,
      ...
      ), /* @__PURE__ */ React5.createElement("small", null, t("dsh-live-voice.speak.segmentGap.help"))), /* @__PURE__ */ React5.createElement("p", null, t("dsh-live-voice.speak.engine.playbackHelp")), ["qwen-http", "say", "browser"].filter((id2) => capabilities[id2]?.supported === false).map((id2) => /* @__PURE__ */ React5.createElement("p", { key: id2, role: "status" }, t("dsh-live-voice.commons.engine.failure", {
        engine: t(
      ...
      }))), /* @__PURE__ */ React5.createElement("div", { className: "dlv-settings-actions" }, /* @__PURE__ */ React5.createElement(
        "button",
        {
          type: "button",
      ...
      ), state.speaking || state.paused ? /* @__PURE__ */ React5.createElement("button", { type: "button", onClick: () => invoke("stopSpeech") }, t("dsh-live-voice.speak.output.stopTest")) : null, /* @__PURE__ */ React5.createElement("button", { type: "button", onClick: () => invoke("refreshCapabilities") }, t("dsh-live-voice.settings.engine.refresh"))))
    ), /* @__PURE__ */ React5.createElement(
      "div",
      {
      ...
      /* @__PURE__ */ React5.createElement("div", { className: "dlv-settings-card-body" }, /* @__PURE__ */ React5.createElement("label", null, t("dsh-live-voice.recognition.engine.label"), /* @__PURE__ */ React5.createElement(
        "select",
        {
        ...
        /* @__PURE__ */ React5.createElement("option", { value: "browser" }, t("dsh-live-voice.recognition.browser.label")),
        /* @__PURE__ */ React5.createElement("option", { value: "qwen-http" }, t("dsh-live-voice.recognition.qwen.label")),
        /* @__PURE__ */ React5.createElement("option", { value: "whisper-http" }, t("dsh-live-voice.recognition.whisper.label")),
        /* @__PURE__ */ React5.createElement("optgroup", { label: t("dsh-live-voice.recognition.planned.vote") }, /* @__PURE__ */ React5.createElement("option", { value: "webgpu", disabled: true }, t("dsh-live-voice.recognition.planned.webGpu")), /* @__PURE__ */ React5.createElement("option", { value: "sherpa-onnx", disabled: true }, t("dsh-live-voice.recognition.planned.sherpa")), /* @__PURE__ */ React5.createElement("option", { value: "parakeet", disabled: true }, t("dsh-live-voice.recognition.planned.parakeet")), /* @__PURE__ */ React5.createElement("option", { value: "voxtral", disabled: true }, t("dsh-live-voice.recognition.planned.voxtral")))
      )), /* @__PURE__ */ React5.createElement("small", { className: "dlv-recognition-engine-description" }, t(
      ...
      ), settings.recognitionEngine === "browser" ? /* @__PURE__ */ React5.createElement("small", null, t("dsh-live-voice.recognition.browser.microphoneHelp")) : null, field("dsh-live-voice.recognition.language.label", "recognitionLang", [
      ...
      ]), settings.recognitionEngine === "browser" ? /* @__PURE__ */ React5.createElement(React5.Fragment, null, /* @__PURE__ */ React5.createElement("label", { className: "dlv-check" }, /* @__PURE__ */ React5.createElement(
        "input",
        {
          type: "checkbox",
      ...
      ), " ", t("dsh-live-voice.recognition.browser.localProcessing")), settings.recognitionProcessLocally !== false ? /* @__PURE__ */ React5.createElement("label", { className: "dlv-check" }, /* @__PURE__ */ React5.createElement(
        "input",
        {
          type: "checkbox",
      ...
      ), " ", t("dsh-live-voice.recognition.browser.autoInstallPack")) : /* @__PURE__ */ React5.createElement("p", { role: "status" }, t("dsh-live-voice.recognition.browser.remoteServiceWarning"))) : /* @__PURE__ */ React5.createElement("p", { role: "status" }, t(
        ...
        /* @__PURE__ */ React5.createElement(WhisperSettings2, { key: "settings", controller })
      ]) : null, settings.recognitionEngine === "qwen-http" && settings.engine !== "qwen-http" ? subcard("dsh-live-voice.speak.qwen.connection", [
        /* @__PURE__ */ React5.createElement(QwenSettings2, { key: "qwen-recognition-settings", controller })
      ]) : null, /* @__PURE__ */ React5.createElement("p", null, t("dsh-live-voice.recognition.providerSettings.help")), subcard("dsh-live-voice.recognition.commands.title", [
        /* @__PURE__ */ React5.createElement("label", { key: "voice-commands-enabled", className: "dlv-check" }, /* @__PURE__ */ React5.createElement(
          "input",
          {
            type: "checkbox",
        ...
        /* @__PURE__ */ React5.createElement("small", { key: "voice-command-help" }, t("dsh-live-voice.recognition.voiceCommands.help")),
        ...[
          [
        ...
        ].map(([label, key, fallback]) => /* @__PURE__ */ React5.createElement("label", { key }, localize(label), /* @__PURE__ */ React5.createElement(
          "textarea",
          {
            rows: 2,
            maxLength: 1e3,
        ...
        /* @__PURE__ */ React5.createElement("label", { key: "recognition-filter", className: "dlv-check" }, /* @__PURE__ */ React5.createElement(
          "input",
          {
            type: "checkbox",
        ...
        /* @__PURE__ */ React5.createElement("label", { key: "recognition-minimum-words" }, t("dsh-live-voice.recognition.minimumWords.label"), /* @__PURE__ */ React5.createElement(
          "input",
          {
            type: "number",
            min: 1,
        ...
        ), /* @__PURE__ */ React5.createElement("small", null, t("dsh-live-voice.recognition.minimumWords.help")))
      ]), capabilities.capture?.supported === false ? /* @__PURE__ */ React5.createElement("p", { role: "status" }, t("dsh-live-voice.recognition.microphone.failure", {
        reason: capabilities.capture.reason
      })) : capabilities.capture?.permission === "prompt" ? /* @__PURE__ */ React5.createElement("p", { role: "status" }, t("dsh-live-voice.recognition.microphone.permissionHelp")) : null, capabilities.recognition?.supported === false ? /* @__PURE__ */ React5.createElement("p", { role: "status" }, capabilities.recognition.reason) : null, usesPluginVoiceDetection(settings.recognitionEngine) ? /* @__PURE__ */ React5.createElement(
        "details",
        {
          className: "dlv-settings-subcard",
          "aria-label": t("dsh-live-voice.recognition.silenceDetection.title")
        },
        /* @__PURE__ */ React5.createElement("summary", null, t("dsh-live-voice.recognition.silenceDetection.label")),
        /* @__PURE__ */ React5.createElement("div", { className: "dlv-settings-subcard-body" }, /* @__PURE__ */ React5.createElement("p", null, t("dsh-live-voice.recognition.silenceDetection.help")), /* @__PURE__ */ React5.createElement("label", { className: "dlv-setting-field" }, t("dsh-live-voice.recognition.maxUtterance.label"), /* @__PURE__ */ React5.createElement(
          "input",
          {
            type: "number",
            min: 10,
        ...
        ), /* @__PURE__ */ React5.createElement("small", null, t("dsh-live-voice.recognition.maxUtterance.help"))), /* @__PURE__ */ React5.createElement(
          "div",
          {
          ...
          Object.entries(voiceDetectionPresets).map(([value, preset]) => /* @__PURE__ */ React5.createElement("label", { key: value, className: "dlv-preset" }, /* @__PURE__ */ React5.createElement(
            "input",
            {
              type: "radio",
              name: "dlv-vad-preset",
              ...
              onChange: () => invoke("updateSettings", {
                voiceDetectionPreset: value
              })
            }
          ), /* @__PURE__ */ React5.createElement("span", null, /* @__PURE__ */ React5.createElement("strong", null, t(`dsh-live-voice.recognition.presets.${value}.label`)), /* @__PURE__ */ React5.createElement("small", null, t(
            `dsh-live-voice.recognition.presets.${value}.description`
          )))))
        ), /* @__PURE__ */ React5.createElement("p", { className: "dlv-vad-summary" }, t("dsh-live-voice.recognition.silenceDetection.duration", {
          milliseconds: voiceDetectionPresets[settings.voiceDetectionPreset]?.silenceMs || voiceDetectionPresets.natural.silenceMs
        })))
      ) : null)
    ), panel("conversation", [
      /* @__PURE__ */ React5.createElement("label", { key: "announce", className: "dlv-check" }, /* @__PURE__ */ React5.createElement(
        "input",
        {
          type: "checkbox",
      ...
      /* @__PURE__ */ React5.createElement("p", { key: "policy" }, t("dsh-live-voice.speak.autoPlayback.help")),
      /* @__PURE__ */ React5.createElement("label", { key: "interrupt-message", className: "dlv-check" }, /* @__PURE__ */ React5.createElement(
        "input",
        {
          type: "checkbox",
      ...
      /* @__PURE__ */ React5.createElement("p", { key: "interrupt-message-description", className: "dlv-setting-description" }, t(
      ...
      /* @__PURE__ */ React5.createElement("label", { key: "hold-to-talk", className: "dlv-check" }, /* @__PURE__ */ React5.createElement(
        "input",
        {
          type: "checkbox",
      ...
      /* @__PURE__ */ React5.createElement("p", { key: "hold-to-talk-description", className: "dlv-setting-description" }, t("dsh-live-voice.recognition.holdToTalk.help")),
      ...
      /* @__PURE__ */ React5.createElement("p", { key: "mode-description", className: "dlv-setting-description" }, t(
        settings.mode === "headphones" ? "dsh-live-voice.recognition.headphoneMode.help" : "dsh-live-voice.recognition.speakerMode.help"
      )),
      /* @__PURE__ */ React5.createElement("label", { key: "speech-delay" }, t("dsh-live-voice.speak.responseDelay.label"), /* @__PURE__ */ React5.createElement(
        "select",
        {
        ...
        [1, 2, 3, 4, 5, 6, 8, 10].map((seconds) => /* @__PURE__ */ React5.createElement("option", { key: seconds, value: String(seconds) }, t("dsh-live-voice.commons.seconds", { seconds })))
      ), /* @__PURE__ */ React5.createElement("small", null, t("dsh-live-voice.speak.responseDelay.help"))),
      ...
      settings.sendingMode !== "manual" ? /* @__PURE__ */ React5.createElement("label", { key: "delay" }, t("dsh-live-voice.settings.autoSend.delay"), /* @__PURE__ */ React5.createElement(
        "select",
        {
        ...
        [2, 3, 4, 5, 6, 8, 10].map((seconds) => /* @__PURE__ */ React5.createElement("option", { key: seconds, value: String(seconds) }, t("dsh-live-voice.commons.seconds", { seconds })))
      ), /* @__PURE__ */ React5.createElement("small", null, t("dsh-live-voice.recognition.autoSend.countdownHelp"))) : /* @__PURE__ */ React5.createElement("p", { key: "manual", className: "dlv-setting-description" }, t("dsh-live-voice.recognition.manualSend.help"))
    ]), /* @__PURE__ */ React5.createElement(
      ErrorText,
      {
        error: error || state.error,
...
function apply(ctx) {
  ...
  function useEntry(sessionId, kind) {
    const [entry, setEntry] = import_react5.default.useState(null);
  ...
  function useComposer(entry, props) {
    ...
    const token = import_react5.default.useRef({});
    import_react5.default.useLayoutEffect(() => {
  ...
  function Buttons(props) {
    ...
    return entry ? /* @__PURE__ */ import_react5.default.createElement(MicrophoneButtons, { controller: entry.controller }) : null;
  }
  function Settings() {
    const [controller, setController] = import_react5.default.useState(null);
    ...
    return controller ? /* @__PURE__ */ import_react5.default.createElement(SettingsPanel, { controller }) : null;
  }
  ctx.slots.inject(
    "settings.section",
    () => ctx.slots.register(
  ...
  function Dock(props) {
    ...
    useComposer(entry, props);
    return entry ? /* @__PURE__ */ import_react5.default.createElement(RecordingBar, { controller: entry.controller }) : null;
  }
  function QuestionStatusView({ entry }) {
    const snapshot = import_react5.default.useSyncExternalStore(
      entry.controller.subscribe,
      entry.controller.getSnapshot
    );
    const [overlayStyle, setOverlayStyle] = import_react5.default.useState();
    import_react5.default.useLayoutEffect(() => {
  ...
  function QuestionStatus(props) {
    ...
    return entry ? /* @__PURE__ */ import_react5.default.createElement(QuestionStatusView, { entry }) : null;
  }
  function ActionView({ entry, messageId }) {
    ...
    const chat = import_react5.default.useSyncExternalStore(entry.subscribeChat, entry.readChat);
  ...
  function Action(props) {
    ...
    return entry ? /* @__PURE__ */ import_react5.default.createElement(ActionView, { entry, messageId: props.messageId }) : null;
  }
  ctx.effect(() => {
