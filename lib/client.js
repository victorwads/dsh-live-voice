...
// src/modules/core/coordinator.ts
...
function NumberField({ label, ...props }) {
  return /* @__PURE__ */ import_react11.default.createElement("label", null, label, /* @__PURE__ */ import_react11.default.createElement("input", { ...props, type: "number" }));
}

// src/shared/design-system/forms/SelectField.tsx
var import_react12 = __toESM(require("react"), 1);
function SelectField({ label, options, ...props }) {
  return /* @__PURE__ */ import_react12.default.createElement("label", null, label, /* @__PURE__ */ import_react12.default.createElement("select", { ...props }, options.map((option) => /* @__PURE__ */ import_react12.default.createElement("option", { key: option.value, value: option.value, disabled: option.disabled }, option.label))));
}

// src/shared/design-system/forms/TextAreaField.tsx
var import_react13 = __toESM(require("react"), 1);
function TextAreaField({ label, ...props }) {
  return /* @__PURE__ */ import_react13.default.createElement("label", null, label, /* @__PURE__ */ import_react13.default.createElement("textarea", { ...props }));
}

// src/shared/design-system/forms/TextField.tsx
var import_react14 = __toESM(require("react"), 1);
function TextField({ label, ...props }) {
  return /* @__PURE__ */ import_react14.default.createElement("label", null, label, /* @__PURE__ */ import_react14.default.createElement("input", { ...props, type: "text" }));
}
...
function SettingsCard({
  ...
  return /* @__PURE__ */ import_react15.default.createElement("div", { className: ["dlv-settings-card", className].filter(Boolean).join(" ") }, children);
}
...
function SettingsSubcard({
  ...
  return /* @__PURE__ */ import_react17.default.createElement("details", { className: "dlv-settings-subcard", open, "aria-label": ariaLabel }, /* @__PURE__ */ import_react17.default.createElement("summary", null, title), /* @__PURE__ */ import_react17.default.createElement("div", { className: "dlv-settings-subcard-body" }, children));
}

// src/shared/design-system/layout/SettingsTabs.tsx
var import_react18 = __toESM(require("react"), 1);
function SettingsTabs({ label, tabs, active, idPrefix, onChange }) {
  const refs = import_react18.default.useRef([]);
  ...
  return /* @__PURE__ */ import_react18.default.createElement("div", { className: "dlv-settings-tabs", role: "tablist", "aria-label": label }, tabs.map((tab, index) => /* @__PURE__ */ import_react18.default.createElement(
    "button",
    {
      key: tab.id,
      ref: (node) => {
...
var abortError2 = () => Object.assign(new Error("Whisper recognition was cancelled."), { name: "AbortError" });
...
// src/modules/recognition/engines/qwen/QwenRecognitionEngine.ts
...
// src/modules/speak/engines/browser/BrowserSpeakingEngine.ts
var abortError3 = () => Object.assign(new Error("Speech playback was cancelled."), { name: "AbortError" });
var BrowserSpeakingEngine = class {
  ...
  async stop() {
    ...
    this.current.finish(abortError3());
    try {
...
// src/modules/speak/engines/qwen/QwenSpeakingEngine.ts
...
function useAudioDevices() {
  const [audioDevices, setAudioDevices] = import_react20.default.useState([]);
...
function createDeviceOptions(devices, kind, systemDefault, fallback) {
  return [
    { value: "", label: systemDefault },
    ...devices.filter((device) => device.kind === kind && device.deviceId && device.deviceId !== "default").map((device, index) => ({
...
function useConversationActions(controller) {
  const [error, setError] = import_react21.default.useState("");
  const alive = import_react21.default.useRef(true);
  ...
  const invoke = import_react21.default.useCallback(
    (name, ...args) => {
      setError("");
      try {
  ...
  const clearError = import_react21.default.useCallback(() => setError(""), []);
...
function useConversationController(controller) {
  const subscribe = import_react22.default.useCallback(
    (listener) => controller.subscribe(listener),
    [controller]
  );
  const read = import_react22.default.useCallback(() => controller.getSnapshot(), [controller]);
  return import_react22.default.useSyncExternalStore(subscribe, read, read);
}
...
function useReleaseStatus() {
  const [latestRelease, setLatestRelease] = import_react23.default.useState(
    null
  );
...
function DeliverySettings({
  ...
  return /* @__PURE__ */ import_react24.default.createElement(import_react24.default.Fragment, null, /* @__PURE__ */ import_react24.default.createElement(
    SelectField,
    {
      ...
      value: mode,
      options: [
        { value: "manual", label: scoped.delivery.manualLabel() },
        { value: "queue", label: scoped.delivery.queueLabel() },
        { value: "steer", label: scoped.delivery.steerLabel() }
      ],
      onChange: (event) => updateSettings({ sendingMode: event.target.value })
    }
  ), mode !== "manual" ? /* @__PURE__ */ import_react24.default.createElement(
    SelectField,
    {
  ...
  ) : /* @__PURE__ */ import_react24.default.createElement("p", { className: "dlv-setting-description" }, scoped.delivery.manualLabel()));
}
...
function HoldToTalkSettings({
  ...
  return /* @__PURE__ */ import_react25.default.createElement(
    CheckboxField,
    {
      ...
      description: recognition.holdToTalk.help(),
...
function VoiceModeSettings({
  ...
  return /* @__PURE__ */ import_react26.default.createElement(import_react26.default.Fragment, null, /* @__PURE__ */ import_react26.default.createElement(
    SelectField,
    {
      ...
      value: mode,
      options: [
        { value: "speaker", label: recognition.speakerMode.label() },
        { value: "headphones", label: recognition.headphoneMode.label() }
      ],
      onChange: (event) => updateSettings({ mode: event.target.value })
    }
  ), /* @__PURE__ */ import_react26.default.createElement("p", { className: "dlv-setting-description" }, mode === "headphones" ? recognition.headphoneMode.help() : recognition.speakerMode.help()));
}
...
function ConversationDelaySettings({ settings, updateSettings }) {
  ...
  ), /* @__PURE__ */ import_react27.default.createElement("p", { className: "dlv-setting-description" }, speak.responseDelay.help()));
}
...
function PlaybackPolicySettings({ settings, updateSettings }) {
  ...
  ), /* @__PURE__ */ import_react28.default.createElement("p", null, speak.autoPlayback.help()), /* @__PURE__ */ import_react28.default.createElement(
    CheckboxField,
    {
  ...
  ), /* @__PURE__ */ import_react28.default.createElement("p", null, settings.interruptSpeechOnUserMessage ? speak.interruption.enabledHelp() : speak.interruption.disabledHelp()));
}

// src/modules/settings/sections/conversation/ConversationSettingsSection.tsx
function ConversationSettingsSection(props) {
  return /* @__PURE__ */ import_react29.default.createElement(SettingsCard, null, /* @__PURE__ */ import_react29.default.createElement("div", { className: "dlv-settings-card-body" }, /* @__PURE__ */ import_react29.default.createElement(DeliverySettings, { ...props }), /* @__PURE__ */ import_react29.default.createElement(HoldToTalkSettings, { ...props }), /* @__PURE__ */ import_react29.default.createElement(VoiceModeSettings, { ...props }), /* @__PURE__ */ import_react29.default.createElement(PlaybackPolicySettings, { ...props }), /* @__PURE__ */ import_react29.default.createElement(ConversationDelaySettings, { ...props })));
}
...
function QwenSettings({ controller }) {
  const { scoped: commons } = useLanguage((ctx) => ctx.commons);
  const { scoped: recognition } = useLanguage((ctx) => ctx.recognition);
  const { scoped: speak } = useLanguage((ctx) => ctx.speak);
  const [draft, setDraft] = import_react30.default.useState({
    baseUrl: "http://127.0.0.1:8080/",
    timeoutMs: 3e5
  });
  const [busy, setBusy] = import_react30.default.useState(true);
  const [loaded, setLoaded] = import_react30.default.useState(false);
  const [error, setError] = import_react30.default.useState("");
  const [message2, setMessage] = import_react30.default.useState("");
  const active = import_react30.default.useRef(null);
  ...
  const field = (label, key, type = "text") => /* @__PURE__ */ import_react30.default.createElement("label", null, label, /* @__PURE__ */ import_react30.default.createElement(
    "input",
    {
      type,
      value: draft[key],
  ...
  return /* @__PURE__ */ import_react30.default.createElement(import_react30.default.Fragment, null, /* @__PURE__ */ import_react30.default.createElement("p", null, recognition.qwen.hostHelp()), field(speak.qwen.endpoint(), "baseUrl"), field(commons.connection.timeout(), "timeoutMs", "number"), /* @__PURE__ */ import_react30.default.createElement("div", { className: "dlv-settings-actions" }, /* @__PURE__ */ import_react30.default.createElement("button", { type: "button", disabled: busy || !loaded, onClick: () => run("save") }, speak.qwen.save()), /* @__PURE__ */ import_react30.default.createElement("button", { type: "button", disabled: busy || !loaded, onClick: () => run("test") }, speak.qwen.test()), /* @__PURE__ */ import_react30.default.createElement("button", { type: "button", disabled: busy, onClick: () => run("load") }, commons.connection.reload())), busy && /* @__PURE__ */ import_react30.default.createElement("p", { role: "status" }, commons.connection.contactingHost()), message2 && /* @__PURE__ */ import_react30.default.createElement("p", { role: "status" }, translateStatus(message2)), error && /* @__PURE__ */ import_react30.default.createElement("p", { role: "alert" }, translateStatus(error)));
}
...
function WhisperSettings({ controller }) {
  const { scoped: commons } = useLanguage((ctx) => ctx.commons);
  const { scoped: recognition } = useLanguage((ctx) => ctx.recognition);
  ...
  const translateStatus = (value) => ({
    ...
    "dsh-live-voice.recognition.whisper.connectionSuccess": recognition.whisper.connectionSuccess(),
  ...
  function field(label, key, type = "text") {
    return /* @__PURE__ */ import_react31.default.createElement("label", null, label, /* @__PURE__ */ import_react31.default.createElement(
      "input",
      {
        type,
        value: draft[key],
...
function RecognitionEngineSettings({
  ...
  return /* @__PURE__ */ import_react32.default.createElement(import_react32.default.Fragment, null, /* @__PURE__ */ import_react32.default.createElement(
    SelectField,
    {
      ...
      options: [
        ...
        {
          value: "qwen-http",
          label: recognition.qwen.label(),
          disabled: capabilities["qwen-http-recognition"]?.supported === false
        },
        {
          value: "whisper-http",
          label: recognition.whisper.label(),
    ...
    SelectField,
    {
      ...
      options: createDeviceOptions(
        ...
        commons.device.numberedLabel({ number: "" })
      ),
    ...
    SelectField,
    {
      ...
      options: [
        ...engine === "browser" ? [] : [{ value: "auto", label: recognition.language.automatic() }],
        { value: "pt-BR", label: "Portugu\xEAs (Brasil)" },
        { value: "en-US", label: "English (US)" }
      ],
      onChange: (event) => updateSettings({ recognitionLang: event.target.value })
    }
  ), engine === "browser" && /* @__PURE__ */ import_react32.default.createElement(import_react32.default.Fragment, null, /* @__PURE__ */ import_react32.default.createElement("p", null, recognition.browser.help()), /* @__PURE__ */ import_react32.default.createElement(
    CheckboxField,
    {
  ...
  ), settings.recognitionProcessLocally !== false ? /* @__PURE__ */ import_react32.default.createElement(
    CheckboxField,
    {
  ...
  ) : /* @__PURE__ */ import_react32.default.createElement("p", { role: "status" }, recognition.browser.remoteServiceWarning())), engine === "whisper-http" && /* @__PURE__ */ import_react32.default.createElement(SettingsSubcard, { title: commons.connection.title() }, /* @__PURE__ */ import_react32.default.createElement("p", null, recognition.whisper.captureHelp()), /* @__PURE__ */ import_react32.default.createElement(WhisperSettings, { controller })), engine === "qwen-http" && /* @__PURE__ */ import_react32.default.createElement(SettingsSubcard, { title: commons.connection.title() }, /* @__PURE__ */ import_react32.default.createElement("p", null, recognition.qwen.captureHelp()), settings.engine !== "qwen-http" && /* @__PURE__ */ import_react32.default.createElement(QwenSettings, { controller })));
}
...
function RecognitionFilterSettings({ settings, updateSettings }) {
  ...
  return /* @__PURE__ */ import_react33.default.createElement(SettingsSubcard, { title: recognition.minimumWords.label() }, /* @__PURE__ */ import_react33.default.createElement(
    CheckboxField,
    {
      label: recognition.minimumWords.enabled(),
      description: recognition.minimumWords.help(),
      checked: enabled,
...
function SilenceDetectionSettings({ settings, updateSettings }) {
  ...
  return /* @__PURE__ */ import_react34.default.createElement(
    ...
    /* @__PURE__ */ import_react34.default.createElement("p", null, recognition.silenceDetection.help()),
    ...
    /* @__PURE__ */ import_react34.default.createElement("small", null, recognition.maxUtterance.help()),
    /* @__PURE__ */ import_react34.default.createElement(
      "div",
      {
      ...
      Object.entries(voiceDetectionPresets).map(([value, preset]) => /* @__PURE__ */ import_react34.default.createElement("label", { key: value, className: "dlv-preset" }, /* @__PURE__ */ import_react34.default.createElement(
        "input",
        {
          type: "radio",
          name: "dlv-vad-preset",
      ...
      ), /* @__PURE__ */ import_react34.default.createElement("span", null, /* @__PURE__ */ import_react34.default.createElement("strong", null, recognition.presets[value].label()), /* @__PURE__ */ import_react34.default.createElement("small", null, recognition.presets[value].description()))))
    ),
    /* @__PURE__ */ import_react34.default.createElement("p", { className: "dlv-vad-summary" }, recognition.silenceDetection.duration({
      milliseconds: voiceDetectionPresets[selected]?.silenceMs || voiceDetectionPresets.natural.silenceMs
    }))
  );
}
...
function VoiceCommandSettings({ settings, updateSettings }) {
  ...
  return /* @__PURE__ */ import_react35.default.createElement(SettingsSubcard, { title: recognition.commands.title() }, /* @__PURE__ */ import_react35.default.createElement(
    CheckboxField,
    {
  ...
  ), /* @__PURE__ */ import_react35.default.createElement("p", { className: "dlv-setting-description" }, recognition.voiceCommands.help()), COMMANDS.map(([label, key, fallback]) => /* @__PURE__ */ import_react35.default.createElement(
    TextAreaField,
    {
      key,
      rows: 2,
      maxLength: 1e3,
      label: recognition.commands[label](),
...
function RecognitionStatus({ capabilities = {} }) {
  const { scoped: recognition } = useLanguage((ctx) => ctx.recognition);
  return /* @__PURE__ */ import_react36.default.createElement(import_react36.default.Fragment, null, capabilities.capture?.supported === false ? /* @__PURE__ */ import_react36.default.createElement("p", { role: "status" }, recognition.microphone.failure({ reason: capabilities.capture.reason || "" })) : capabilities.capture?.permission === "prompt" ? /* @__PURE__ */ import_react36.default.createElement("p", { role: "status" }, recognition.microphone.permissionHelp()) : null, capabilities.recognition?.supported === false && /* @__PURE__ */ import_react36.default.createElement("p", { role: "status" }, capabilities.recognition.reason));
}

// src/modules/settings/sections/recognition/RecognitionSettingsSection.tsx
function RecognitionSettingsSection(props) {
  return /* @__PURE__ */ import_react37.default.createElement(SettingsCard, null, /* @__PURE__ */ import_react37.default.createElement("div", { className: "dlv-settings-card-body" }, /* @__PURE__ */ import_react37.default.createElement(RecognitionEngineSettings, { ...props }), /* @__PURE__ */ import_react37.default.createElement(VoiceCommandSettings, { ...props }), /* @__PURE__ */ import_react37.default.createElement(RecognitionFilterSettings, { ...props }), /* @__PURE__ */ import_react37.default.createElement(SilenceDetectionSettings, { ...props }), /* @__PURE__ */ import_react37.default.createElement(RecognitionStatus, { ...props })));
}
...
function OutputFilterSettings({ settings, updateSettings }) {
  ...
  return /* @__PURE__ */ import_react38.default.createElement(SettingsSubcard, { title: speak.filters.code.enabled() }, /* @__PURE__ */ import_react38.default.createElement(
    CheckboxField,
    {
    ...
    TextField,
    {
      ...
      defaultValue: settings.outputCodeNotice || speak.filters.code.notice(),
      disabled: !enabled,
...
function SpeechEngineSettings({ settings, capabilities, updateSettings }) {
  ...
  ), engine === "qwen-http" && /* @__PURE__ */ import_react39.default.createElement(
    SelectField,
    {
  ...
  ), capabilities?.[engine === "qwen-http" ? "qwen" : engine]?.supported === false && /* @__PURE__ */ import_react39.default.createElement("p", { role: "status" }, capabilities?.[engine === "qwen-http" ? "qwen" : engine]?.reason || commons.engine.failure()));
}
...
function SpeechAdvancedSettings({
  ...
  return /* @__PURE__ */ import_react40.default.createElement(import_react40.default.Fragment, null, settings.engine !== "say" ? /* @__PURE__ */ import_react40.default.createElement(
    SelectField,
    {
  ...
  ) : /* @__PURE__ */ import_react40.default.createElement("p", { className: "dlv-setting-description" }, speak.macos.outputHelp()), settings.engine === "qwen-http" && /* @__PURE__ */ import_react40.default.createElement(SettingsSubcard, { title: speak.qwen.connection() }, /* @__PURE__ */ import_react40.default.createElement(QwenSettings, { controller })), /* @__PURE__ */ import_react40.default.createElement(SettingsSubcard, { title: speak.agentContext.label() }, /* @__PURE__ */ import_react40.default.createElement(
    CheckboxField,
    {
  ...
  )), /* @__PURE__ */ import_react40.default.createElement("p", null, speak.engine.playbackHelp()), /* @__PURE__ */ import_react40.default.createElement("div", { className: "dlv-settings-actions" }, /* @__PURE__ */ import_react40.default.createElement("button", { type: "button", onClick: () => invoke("speak", speak.output.testPhrase()) }, speak.output.test()), speaking && /* @__PURE__ */ import_react40.default.createElement("button", { type: "button", onClick: () => invoke("stopSpeech") }, speak.output.stopTest()), /* @__PURE__ */ import_react40.default.createElement("button", { type: "button", onClick: () => invoke("refreshCapabilities") }, settingsLanguage.engine.refresh())));
}

// src/modules/settings/sections/speak/SpeakSettingsSection.tsx
function SpeakSettingsSection(props) {
  return /* @__PURE__ */ import_react41.default.createElement(SettingsCard, null, /* @__PURE__ */ import_react41.default.createElement("div", { className: "dlv-settings-card-body" }, /* @__PURE__ */ import_react41.default.createElement(SpeechEngineSettings, { ...props }), /* @__PURE__ */ import_react41.default.createElement(SpeechAdvancedSettings, { ...props }), /* @__PURE__ */ import_react41.default.createElement(OutputFilterSettings, { ...props })));
}
...
function VersionBadges() {
  const { scoped: commons } = useLanguage((ctx) => ctx.commons);
  return /* @__PURE__ */ import_react42.default.createElement("div", { className: "dlv-version-badges", "aria-label": commons.version.title() }, /* @__PURE__ */ import_react42.default.createElement(
    "a",
    {
    ...
    /* @__PURE__ */ import_react42.default.createElement("img", { src: LIVE_VOICE_BADGE_URL, alt: "" }),
    /* @__PURE__ */ import_react42.default.createElement("span", null, `v${CURRENT_VERSION}`)
    ...
    /* @__PURE__ */ import_react42.default.createElement("img", { src: DSH_BADGE_URL, alt: "" }),
    /* @__PURE__ */ import_react42.default.createElement("span", null, `v${TESTED_DSH_VERSION}`)
  ));
}
...
function SettingsHeader({ onClose }) {
  ...
  return /* @__PURE__ */ import_react43.default.createElement("div", { className: "dlv-settings-heading" }, /* @__PURE__ */ import_react43.default.createElement("h3", null, commons.pluginName()), /* @__PURE__ */ import_react43.default.createElement(VersionBadges, null), /* @__PURE__ */ import_react43.default.createElement("span", { className: "dlv-heading-divider", "aria-hidden": true }), updateAvailable && latestRelease ? /* @__PURE__ */ import_react43.default.createElement(import_react43.default.Fragment, null, /* @__PURE__ */ import_react43.default.createElement(
    "a",
    {
    ...
    /* @__PURE__ */ import_react43.default.createElement("span", { className: "dlv-update-icon", "aria-hidden": true }, "\u2191"),
    commons.update.label()
  ), /* @__PURE__ */ import_react43.default.createElement("span", { className: "dlv-heading-divider", "aria-hidden": true })) : null, /* @__PURE__ */ import_react43.default.createElement(
    "a",
    {
  ...
  ), onClose ? /* @__PURE__ */ import_react43.default.createElement(IconButton, { icon: "close", label: settings.close(), onClick: onClose }) : null);
}
...
function LiveVoiceSettings({ controller, onClose }) {
  ...
  const [activeTab, setActiveTab] = import_react44.default.useState("conversation");
  const tabsId = import_react44.default.useId();
  const tabs = [
    { id: "speech", label: settingsLanguage.tabs.speak() },
    { id: "recognition", label: settingsLanguage.tabs.recognition() },
    { id: "conversation", label: settingsLanguage.tabs.conversation() }
  ];
  const sectionProps = {
    controller,
  ...
  return /* @__PURE__ */ import_react44.default.createElement("section", { className: "dlv-settings", "aria-label": settingsLanguage.title() }, /* @__PURE__ */ import_react44.default.createElement(SettingsHeader, { onClose }), /* @__PURE__ */ import_react44.default.createElement(
    SettingsTabs,
    {
  ...
  ), tabs.map((tab) => /* @__PURE__ */ import_react44.default.createElement(
    "div",
    {
      key: tab.id,
    ...
    tab.id === "speech" ? /* @__PURE__ */ import_react44.default.createElement(SpeakSettingsSection, { ...sectionProps }) : tab.id === "recognition" ? /* @__PURE__ */ import_react44.default.createElement(RecognitionSettingsSection, { ...sectionProps }) : /* @__PURE__ */ import_react44.default.createElement(ConversationSettingsSection, { ...sectionProps })
...
function createLiveVoiceSettings(..._legacyArguments) {
  return function SettingsPanel({ controller, onClose }) {
    return /* @__PURE__ */ import_react45.default.createElement(LiveVoiceSettings, { controller, onClose });
  };
}
...
function MicrophoneButton(props) {
  return /* @__PURE__ */ import_react46.default.createElement(IconButton, { ...props, className: "dlv-mic", icon: "mic" });
}

// src/modules/conversation/components/ConversationControls.tsx
function ConversationControls({ controller }) {
  const { scoped: commons } = useLanguage((ctx) => ctx.commons);
  const { scoped: recognition } = useLanguage((ctx) => ctx.recognition);
  const state = useConversationController(controller);
  const { invoke, error, clearError } = useConversationActions(controller);
...
function PlaybackControls({ state, invoke }) {
  ...
  return /* @__PURE__ */ import_react49.default.createElement(import_react49.default.Fragment, null, state.speechSegmentsRemaining > 1 ? /* @__PURE__ */ import_react49.default.createElement(
    IconButton,
    {
  ...
  ) : null, state.speechSegmentsRemaining > 0 && capabilities.pause ? /* @__PURE__ */ import_react49.default.createElement(
    IconButton,
    {
  ...
  ) : null, state.paused && capabilities.resume ? /* @__PURE__ */ import_react49.default.createElement(
    IconButton,
    {
  ...
  ) : null, state.speechSegmentsRemaining > 0 ? /* @__PURE__ */ import_react49.default.createElement(
    IconButton,
    {
...
function Waveform({ controller, enabled }) {
  ...
  return /* @__PURE__ */ import_react50.default.createElement("canvas", { ref, className: "dlv-wave", "aria-hidden": true });
}
...
function ConversationStatusBar({
  ...
  const state = useConversationController(controller);
  const { invoke, error, clearError } = useConversationActions(controller);
  const [now, setNow] = import_react51.default.useState(Date.now());
  ...
  return /* @__PURE__ */ import_react51.default.createElement(
    ...
    /* @__PURE__ */ import_react51.default.createElement("div", { className: "dlv-pill", role: "group", "aria-label": commons.controls.title() }, capture && !state.conversation ? /* @__PURE__ */ import_react51.default.createElement(
      IconButton,
      {
    ...
    ) : null, state.conversation ? /* @__PURE__ */ import_react51.default.createElement(
      IconButton,
      {
    ...
    ) : null, /* @__PURE__ */ import_react51.default.createElement(Waveform, { controller, enabled: Boolean(state.listening) }), /* @__PURE__ */ import_react51.default.createElement("span", { className: "dlv-status", role: "status", "aria-live": "polite" }, status), /* @__PURE__ */ import_react51.default.createElement(
      DeliveryModeButton,
      {
    ...
    ), remaining ? /* @__PURE__ */ import_react51.default.createElement(
      IconButton,
      {
    ...
    ) : null, state.conversation && !capture ? /* @__PURE__ */ import_react51.default.createElement(
      IconButton,
      {
    ...
    ) : null, capture ? /* @__PURE__ */ import_react51.default.createElement(
      IconButton,
      {
    ...
    ) : null, /* @__PURE__ */ import_react51.default.createElement(PlaybackControls, { state, invoke })),
    /* @__PURE__ */ import_react51.default.createElement(
      ErrorMessage,
      {
        error: error || state.error,
...
// src/modules/conversation/models/chat.ts
...
function pendingQuestionSpeech(interaction, index = 0) {
  if (!interaction || interaction.kind !== "question" || !Array.isArray(interaction.questions))
    return "";
...
var SETTINGS_SLOT = Object.freeze({
  name: "settings.section",
  id: "dsh-live-voice",
  order: 65
});
var CLIENT_SLOT_DEFINITIONS = Object.freeze([
  Object.freeze({
...
// src/app/client/registerSlots.tsx
function registerSettingsSlot(ctx, component, label) {
  return ctx.slots.inject(
    SETTINGS_SLOT.name,
    () => ctx.slots.register({ ...SETTINGS_SLOT, label }, withAppLanguage(component, ctx.locale))
  );
}
function registerConversationSlots(ctx, components, label) {
...
function apply(ctx) {
  ...
  function useEntry(sessionId, kind) {
    const [entry, setEntry] = import_react53.default.useState(null);
  ...
  function useComposer(entry, props) {
    ...
    const token = import_react53.default.useRef({});
    import_react53.default.useLayoutEffect(() => {
  ...
  function Buttons(props) {
    ...
    return entry ? /* @__PURE__ */ import_react53.default.createElement(ConversationControls, { controller: entry.controller }) : null;
  }
  function Settings() {
    const [controller, setController] = import_react53.default.useState(null);
    ...
    return controller ? /* @__PURE__ */ import_react53.default.createElement(SettingsPanel, { controller }) : null;
  }
  registerSettingsSlot(ctx, Settings, () => t("dsh-live-voice.commons.pluginName"));
  function Dock(props) {
    const entry = useEntry(props.sessionId, "dock");
    useComposer(entry, props);
    return entry ? /* @__PURE__ */ import_react53.default.createElement(ConversationStatusBar, { controller: entry.controller }) : null;
  }
  function QuestionStatusView({ entry }) {
    const snapshot = import_react53.default.useSyncExternalStore(
      entry.controller.subscribe,
      entry.controller.getSnapshot
    );
    const [overlayStyle, setOverlayStyle] = import_react53.default.useState();
    import_react53.default.useLayoutEffect(() => {
  ...
  function QuestionStatus(props) {
    ...
    return entry ? /* @__PURE__ */ import_react53.default.createElement(QuestionStatusView, { entry }) : null;
  }
  function ActionView({ entry, messageId }) {
    ...
    const chat = import_react53.default.useSyncExternalStore(entry.subscribeChat, entry.readChat);
  ...
  function Action(props) {
    ...
    return entry ? /* @__PURE__ */ import_react53.default.createElement(ActionView, { entry, messageId: props.messageId }) : null;
  }
  ctx.effect(() => {
