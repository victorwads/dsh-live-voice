      ...
      h(
        ...
        h(
          ...
          h(
            ...
            settings.recognitionEngine === "qwen-http" ? "HTTP API at the configured base URL (default: http://127.0.0.1:8080/). Compatible with POST /v1/audio/transcriptions." : settings.recognitionEngine === "whisper-http" ? "HTTP API at the configured DSH host URL (default: http://127.0.0.1:8080/inference). Audio uses the authenticated DSH host transcription route." : "Uses the browser SpeechRecognition API. This is the default option."
          ),
